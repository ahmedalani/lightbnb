...
const addProperty = function (property) {
  ...
  let cost_per_night_new = cost_per_night * 100;
  let values = [owner_id, title, description, thumbnail_photo_url, cover_photo_url, cost_per_night_new, street, city, province, post_code, country, parking_spaces, number_of_bathrooms, number_of_bedrooms];
  const queryString = `
